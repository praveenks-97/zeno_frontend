...
import { Loader2, Rocket, ArrowRight, Lock, User } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        ...
        />
        <div
          className="absolute -bottom-40 -right-20 w-96 h-96 rounded-full opacity-15 blur-3xl"
        ...
        >
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="mt-2 text-sm text-white/50 font-medium text-center">
              Sign in to manage your hosted static sites
            </p>
          </div>
